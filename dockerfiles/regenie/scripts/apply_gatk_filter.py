...
@click.option(
    ...
    required=True,
    type=str,
    help="Annotated, jointly called VCF",
)
@click.option(
    "-o",
    "--out",
    required=True,
    type=str,
    help="the output file name of the variant level results",
)
def main(annotated_vcf, out):
    """This script applies GATK best practice filter
    ...
    python apply_gatk_filter.py -a annotated_vcf.vcf -o annotated_vcf_filtered.txt
