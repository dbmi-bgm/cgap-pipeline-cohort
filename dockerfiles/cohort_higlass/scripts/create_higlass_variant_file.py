# This has been merged into create_variant_result_file.py
...
#        that the Higlass browser can understand. It also adds Fisher exact test p-values to the 
#        resulting VCF (INFO field).
